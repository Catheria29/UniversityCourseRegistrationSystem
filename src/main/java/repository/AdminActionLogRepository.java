...
public class AdminActionLogRepository implements Repository<AdminActionLog, String> {
    ...
    @Override
    public Optional<AdminActionLog> findById(String s) {
    ...
    @Override
    public PagedList<AdminActionLog> findAll(int page, int pageSize) {
        return repository.findAll(page, pageSize);
    }

    @Override
    public AdminActionLog save(AdminActionLog entity) {
